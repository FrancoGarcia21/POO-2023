...
class Persona:
    ...
    def __init__(self,nombre,apellido,fecha_nacimiento,sexo,estudia,trabaja,puesto):
    ...
    def info_persona(self):
        return (f"Nombre: {self.__nombre}. Apellido: {self.__apellido}. Edad: {self.devolver_edad()}. Sexo {self.__sexo}. Trabaja: {self.__trabaja}. Estudia: {self.__estudia}. Puesto: {self.__puesto.get_puesto()}")
